        ...
        <div class="header">
            ...
            <div class="container">
                ...
                <div class="main-content">
                        <div class="tblview" >
                        <h2 style="color:white;margin:50px auto;text-align:center;">Delete Records</h2>
                            <table>
                                <tr>
                                    <th>
                                        Employee ID
                               ...
                               while($row=mysqli_fetch_array($result))
                               {
                                ...
                                <tr>
                                    ...
                                    <td><a href="delete.php?id=<?php echo $row['ID'];?>" style="text-decoration:none;color:white;padding:7px;text-align:center;background:#c52138;">delete</a></td>
                                </tr>
                                <?php
                               }
                                ?>
